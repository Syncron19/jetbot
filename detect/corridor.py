...
if __name__ == '__main__':
    ...
    class_net = jetson_inference.imageNet(opt.network, argv=['--model=/home/orin/jetbot/models/corridor_final1.onnx', '--labels=/home/orin/jetbot/models/corridorLabels.txt', '--input-blob=input_0', '--output-blob=output_0'])
    ...
    display = jetson_utils.videoOutput("rtp://216.96.231.106:1234", argv=sys.argv + is_headless)
